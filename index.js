...
app.post('/api/ops/bridge/chat', express.json({ limit:'200kb' }), (req, res) => {
  ...
  // Bridged teammate comms should never generate ClawdList/DEL, but should be visible in chat.
